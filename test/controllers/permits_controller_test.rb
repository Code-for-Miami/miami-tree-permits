...
class PermitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permit" do
    assert_difference('Permit.count') do
      post permits_url, params: { permit: { address: @permit.address, city_source_id: @permit.city_source_id, lat: @permit.lat, long: @permit.long, status_date: @permit.status_date } }
    end
  ...
  test "should update permit" do
    patch permit_url(@permit), params: { permit: { address: @permit.address, city_source_id: @permit.city_source_id, lat: @permit.lat, long: @permit.long, status_date: @permit.status_date } }
